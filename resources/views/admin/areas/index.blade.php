    ...
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col-md-8">
                ...
                <p class="fw-bold">A user dashboard lets you easily gather and visualize user data from optimizing their
                    experience and ensuring customer retention.</p>
            </div>
            <div class="col-md-4">
                <br>
                <a href="{{ url('admin/areas/create') }}" class="btn btn-lg  mx-5"
                        ...
                        <tr>
                                    ...
                                    @if ($area->phases && sizeof($area->phases) > 0)
                                        @foreach ($area->phases as $phase)
                                            <div class="col-1 mb-2 mt-1 mx-1">
                                                <span class=" m-1  "
                                                    style="border: 1px solid;padding: 5px 8px;border-radius: 5px;">{{ $phase->title }}</span>
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
                            ...
                            <td class="d-flex">
                                ...
                                <div style="margin-left: 6px;">
                                    <a href="{{ url('admin/areas/' . $area->id . '/edit') }}"><button
                                            class="btn btn-primary" style="background:#1F26A2 !important">
                                            <svg width="13" height="13" viewBox="0 0 13 13" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_803_1135)">
                                                    <path
                                                        d="M1.99936 8.87503V10.75H3.87436L9.40436 5.22003L7.52936 3.34503L1.99936 8.87503ZM10.8544 3.77003C11.0494 3.57503 11.0494 3.26003 10.8544 3.06503L9.68436 1.89503C9.48936 1.70003 9.17436 1.70003 8.97936 1.89503L8.06436 2.81003L9.93936 4.68503L10.8544 3.77003V3.77003Z"
                                                        fill="white" />
                                                </g>
                                                <defs>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">{{$area->name}} delete</h1>
        ...
        <form action="{{ url('admin/areas/' . $area->id) }}" method="post"
            ...
            <div class="modal-body">
                Are your sure you want to delete {{$area->name}}? if yes the press delete button if no press cancel.
            </div>
