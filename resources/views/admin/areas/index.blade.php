                            ...
                            <td class="d-flex">
                                ...
                                <div style="margin-left: 6px;">
                                    ...
                                    <button type="button" class="btn"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#exampleModal{{ $area->id }}">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">{{ $area->name }}
                                                        delete</h1>
                                                ...
                                                <form action="{{ url('admin/areas/' . $area->id) }}" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        Are your sure you want to delete {{ $area->name }}? if yes the
                                                        press delete button if no press cancel.
                                                    </div>
